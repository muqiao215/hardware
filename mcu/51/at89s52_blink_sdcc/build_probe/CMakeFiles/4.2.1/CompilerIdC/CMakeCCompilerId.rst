      ...
      000000 02 00 06         [24]  105 	ljmp	__sdcc_gsinit_startup
                                    ...
                                    119 ;	CMakeCCompilerId.c:471: char const* info_compiler = "INFO" ":" "compiler[" COMPILER_ID "]";
      ...
      000065 75 0A 80         [24]  122 	mov	(_info_compiler + 2),#0x80
                                    123 ;	CMakeCCompilerId.c:855: char const* info_platform = "INFO" ":" "platform[" PLATFORM_ID "]";
      ...
      00006E 75 0D 80         [24]  126 	mov	(_info_platform + 2),#0x80
                                    127 ;	CMakeCCompilerId.c:856: char const* info_arch = "INFO" ":" "arch[" ARCHITECTURE_ID "]";
      ...
      000077 75 10 80         [24]  130 	mov	(_info_arch + 2),#0x80
                                    131 ;	CMakeCCompilerId.c:886: const char* info_language_standard_default =
      ...
      000080 75 13 80         [24]  134 	mov	(_info_language_standard_default + 2),#0x80
                                    135 ;	CMakeCCompilerId.c:889: const char* info_language_extensions_default = "INFO" ":" "extensions_default["
      ...
      000003 02 00 8F         [24]  147 	ljmp	_main
                                    ...
                                    159 ;------------------------------------------------------------
                                    160 ;	CMakeCCompilerId.c:907: int main(int argc, char* argv[])
                                    161 ;	-----------------------------------------
                                    162 ;	 function main
                                    163 ;	-----------------------------------------
      00008F                        164 _main:
      ...
      000091 AF 83            [24]  174 	mov	r7,dph
                                    175 ;	CMakeCCompilerId.c:911: require += info_compiler[argc];
      ...
      0000A7 7D 00            [12]  188 	mov	r5,#0x00
                                    189 ;	CMakeCCompilerId.c:912: require += info_platform[argc];
      ...
      0000C2 FC               [12]  206 	mov	r4,a
                                    207 ;	CMakeCCompilerId.c:913: require += info_arch[argc];
      ...
      0000DC FD               [12]  224 	mov	r5,a
                                    225 ;	CMakeCCompilerId.c:915: require += info_version[argc];
      ...
      0000EF FB               [12]  239 	mov	r3,a
                                    240 ;	CMakeCCompilerId.c:929: require += info_language_standard_default[argc];
      ...
      000109 FB               [12]  257 	mov	r3,a
                                    258 ;	CMakeCCompilerId.c:930: require += info_language_extensions_default[argc];
      ...
      000124 F5 83            [12]  275 	mov	dph,a
                                    276 ;	CMakeCCompilerId.c:932: return require;
                                    277 ;	CMakeCCompilerId.c:933: }
